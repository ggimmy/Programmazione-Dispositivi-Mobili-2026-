### [Lezione 1](https://github.com/ggimmy/Programmazione-Dispositivi-Mobili-2026-/blob/main/Lezioni/Lezione_1.kt)

Introduzione al linguaggio Kotlin, i suoi costrutti e le implementazioni di NULL SAFETY.

---
### [Lezione 2](https://github.com/ggimmy/Programmazione-Dispositivi-Mobili-2026-/blob/main/Lezioni/Lezione_2.kt)

Differenza fra operatore ```and``` e ```&&``` (analogo per ```or```,```||```), operatori ```let``` e ```run```, ```todo()```, manipolazione di stringhe, funzioni lambda ed esercizi vari sugli argomenti trattati fin ora. ([homework](https://github.com/ggimmy/Programmazione-Dispositivi-Mobili-2026-/blob/main/esercizi/homework_1.kt))
